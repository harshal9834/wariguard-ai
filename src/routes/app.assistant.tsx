  ...
  head: () => ({
    meta: [
      { title: "VariMitra AI Assistant · VARI-SENSE" },
      {
        name: "description",
        content:
          "Multilingual AI assistant for routes, food centres, medical camps and emergency guidance.",
      },
    ],
  }),
  component: Assistant,
...
const seed = [
  ...
  {
    role: "ai",
    text: "सर्वात जवळचं अन्नदान केंद्र 'अन्नदान केंद्र २' आहे — ६०० मीटर, चालत ८ मिनिटं. सध्या रांग कमी आहे. मी मार्ग नकाशावर दाखवू का?",
  },
  { role: "user", text: "Suggest a safe route to Pandharpur avoiding the crowd." },
  {
    role: "ai",
    text: "Ring Road B is currently the safest route: 18% lower density, adds 6 minutes. Two water stations and one medical camp are on the way. Shall I start voice navigation?",
  },
];
...
const quick = [
  ...
  "Water station near me",
  "Emergency guidance",
  "Today's ringan timing",
];
...
function Assistant() {
  ...
  const send = (text: string) => {
    ...
    setMsgs((m) => [
      ...
      {
        role: "ai",
        text: "VariMitra AI is looking that up across live crowd, resource and medical data for your zone…",
      },
    ]);
    setInput("");
  };
        ...
        <div className="surface-card flex h-[560px] flex-col p-4 xl:col-span-3">
          <div className="flex items-center gap-2 border-b pb-3">
            ...
            <Badge variant="outline" className="ml-auto gap-1">
              <Languages className="size-3" /> 3 languages
            </Badge>
          </div>
          ...
          >
            ...
            <Input
              ...
              placeholder={`Ask VariMitra in ${lang}…`}
            />
        ...
        <div className="space-y-4">
          <div className="surface-card p-4">
            ...
            <ul className="text-muted-foreground mt-2 space-y-1.5 text-[12px]">
              {[
                "Answer pilgrim questions",
                "Find nearest food centre",
                "Find medical camp",
                "Suggest safe route",
                "Emergency guidance",
                ...
                <li key={c} className="flex gap-2">
                  <span className="bg-saffron mt-1.5 size-1.5 rounded-full" />
                  {c}
                </li>
              ))}
            </ul>
          ...
          <div className="gradient-navy rounded-2xl p-4 text-white">
            ...
            <p className="mt-1.5 text-[12px] text-white/75">
              Same assistant on WhatsApp: SOS, nearby volunteer, live route, food and medical help —
