  ...
  head: () => ({
    meta: [
      { title: "Resource Management · VARI-SENSE" },
      {
        name: "description",
        content:
          "Stock levels, consumption rates and AI demand forecasting for water, food, medical kits and vehicles.",
      },
    ],
  }),
  component: Resources,
        ...
        <div className="surface-card p-4">
          ...
          <div className="mt-3 space-y-2">
            {[
              ...
              <div
                key={r.z}
                className="bg-muted/40 flex items-center justify-between rounded-lg p-2.5"
              >
                <div>
